...
for (let i = 0; i < deviceCoordinates.length; i++) 
{
    ...
    for (let i = 0; i < linkStationData.length; i++) 
    {
        ...
        deviceDistance = getDistance(deviceCoordinatesX, deviceCoordinatesY, linkStationX, linkStationY);
  
        console.log("deviceDistance = " + deviceDistance);
...
function getDistance(deviceX, deviceY, linkStationX, linkStationY)
{
